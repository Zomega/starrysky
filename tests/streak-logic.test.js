...
global.document = {
  getElementById: () => ({ content: { cloneNode: () => ({ firstElementChild: {} }) } }),
...
function testGetGridDataForRange() {
  ...
  const checkins = [
    { subject: 'Test', createdAt: '2026-02-01T12:00:00Z', sequence: 1, freezesClaimed: 0 },
    { subject: 'Test', createdAt: '2026-02-02T12:00:00Z', sequence: 2, freezesClaimed: 0 },
    // Gap on 03, 04
    { subject: 'Test', createdAt: '2026-02-05T12:00:00Z', sequence: 5, freezesClaimed: 2 },
  ];

  const result = getGridDataForRange(checkins, 'Test', '2026-02-01', '2026-02-05');
  ...
  const result2 = getGridDataForRange(checkins, 'Test', '2026-01-31', '2026-02-02');
